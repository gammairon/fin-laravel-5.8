           ...
           <div class="col-md-12">
               ...
               <div class="seo-block p-3">
                   <ul class="nav nav-pills mb-3" id="seo-tab" role="tablist">
                       ...
                       {{--<li class="nav-item">
                           <a class="nav-link success" id="pills-author-tab" data-toggle="pill" href="#author-tag" role="tab" aria-controls="author-tag" aria-selected="false">Author Archive</a>
                       </li>--}}
                   ...
                   <div class="tab-content" id="pills-tabContent">
                           ...
                           <div class="row">
                               <div class="col-xs-12 col-md-12">
                                   <div class="form-group">
                                       ...
                                       <div>
                                           <input id="global[site_name]" type="text" class="form-control{{ $errors->has('seo.title') ? ' is-invalid' : '' }}" name="global[site_name]" value="{{ old('global.site_name', $siteName) }}">
                               ...
                               <div class="col-xs-12 col-md-12">
                                   <div class="form-group">
                                       ...
                                       <div>
                                           <textarea name="global[site_description]" id="global[site_description]" class="form-control">{{old('global.site_description', $siteDescription)}}</textarea>
                       ...
                       <div class="tab-pane fade" id="author-tag" role="tabpanel" aria-labelledby="author-tag-tab">
                           @include('admin.partials.setting_seo_block', ['name' => 'author', 'additionRegex' => ['%%author_name%%' => 'Полное имя Автора'], 'seoModel' => $authorSeo])
                       </div>
