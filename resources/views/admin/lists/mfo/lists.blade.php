...
<div id="dragDrop" class="row">
    <div class="col-xs-12 col-md-6">
        ...
        <draggable v-cloak class="admin-lists" tag="ul" :list="defaultMfos" :group="{ name: 'mfo', pull: 'clone', put: false }" @change="log" >
    ...
    <div class="col-xs-12 col-md-6">
        ...
        <draggable v-cloak class="admin-lists" tag="ul" :list="selectedMfos" group="mfo" @change="log" >
            <li
                class="d-flex align-items-center mb-3 justify-content-between list"
