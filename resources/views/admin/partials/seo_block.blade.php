...
<div class="row mt-4 mb-3">
    <div class="col">
        <h3>
            <button class="btn btn-block btn-default" type="button" data-toggle="collapse" data-target="#collapseSeo" aria-expanded="true" aria-controls="collapseSeo">
                SEO <span class="badge badge-secondary"><i class="fa fa-angle-down"></i></span>
            </button>
        </h3>
    </div>
</div>

<div id="collapseSeo" class="collapse" aria-labelledby="headingSeo">
    <div class="row">
