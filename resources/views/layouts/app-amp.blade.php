...
<html amp lang="ru">
    ...
    <body>
        ...
        <header class="header container">
            <div class="left">
                <a class="logo" href="{{route('home')}}">
                    <amp-img src="{{asset('/storage/images/logo.png')}}" width="150" height="40" alt="Finfin"></amp-img>
                </a>
            </div>
            <div class="right">
        ...
        <nav role="menu" class="menu_container" [class]="isMenuOpen ? 'menu_container active' : 'menu_container'">
            <ul>
                <li>
                    <h5>Новости</h5>
                    <ul class="menu-items">
                        <li><a class="menu-item" href="{{ route('news')}}">Все новости</a></li>

                        @foreach ($categories as $category)
                            <li><a class="menu-item" href="{{ route('category', $category) }}">{{$category->name}}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li>
                    <h5>Банки</h5>
                    <ul class="menu-items">
                        <li class="menu-items"><a class="menu-item" href="{{ route('banki')}}">Все Банки</a></li>
                    </ul>
                </li>
                <li>
                    <h5>МФО</h5>
                    <ul class="menu-items">
                        <li><a class="menu-item" href="{{ route('mfo.all')}}">Все МФО</a></li>
                    </ul>
                </li>
                {{--<li>
                    <h5>Карты</h5>
                    <ul class="menu-items">
                        <li><a class="menu-item" href="{{ route('products.cards.all')}}">Кредитные Карты</a></li>
                    </ul>
                </li>
                <li>
                    <h5>Кредиты</h5>
                    <ul class="menu-items">
                        <li><a class="menu-item" href="{{ route('products.cash.all')}}">Кредиты Наличными</a></li>
                    </ul>
        ...
        <footer class="footer-amp container">
            ...
            <a href="{{ route('home') }}"><amp-img src="{{asset('/storage/images/logo.png')}}" width="150" height="40"  alt="Finfin"></amp-img></a>
        </footer>
    </body>
</html>
