...
class SeoController extends Controller
{
    ...
    public function edit()
    {
        ...
        $authorSeo = Seo::firstOrNew(['seoeable_type' => Seo::AUTHOR_ARCHIVE_SEO]);
        ...
        return view('admin.seo', compact('siteName', 'siteDescription','frontSeo', 'newsSeo', 'categoriesSeo', 'tagsSeo', 'authorSeo', 'creditCardsSeo', 'creditCashSeo', 'mfoSeo', 'banksSeo'));
    }
